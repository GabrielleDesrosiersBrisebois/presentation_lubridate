...
- Pour créer des données de type dates/heures. 
...
# Les types de variables dans `lubridate` et `hms`
...
- Une journée (année-mois-jour) qui correspond au nombre de jours écoulés depuis le 1970-01-01.
