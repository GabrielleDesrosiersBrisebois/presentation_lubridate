...
```{r echo=FALSE}
kable(head(bixi_new), caption = "Modification de la variable start_date") %>%
  kable_styling(full_width = FALSE, font_size = 12) %>% 
...
```{r echo=FALSE}
kable(head(bixi_new), caption = "Application de la fonction ymd()") %>%
  kable_styling(full_width = FALSE, font_size = 12) %>% 
  scroll_box(width = "1080px", height = "150px")
```
...
background-image: url("images/cheat_sheet.png")
